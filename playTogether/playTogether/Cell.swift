...
class Cell: UITableViewCell {
    ...
    class func themeCellWithTableView(tableView: UITableView) -> Cell {
        let identifier = "themeCell"
        var cell = tableView.dequeueReusableCellWithIdentifier(identifier) as? Cell
        if cell == nil {
            cell = NSBundle.mainBundle().loadNibNamed("ThemeCell", owner: nil, options: nil).last as? Cell
